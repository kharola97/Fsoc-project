...
router.get("/getRecipeByUser/:userId", authentication, recipeController.getRecipeByUser)
...
router.get("/getrecipe/:userId", authentication,  recipeController.getRecipe)
//api to get recipe by recipeId
router.get("/recipeById/:recipeId",authentication, recipeController.recipeById)
...
router.post("/comment/:userId/:recipeId" ,authentication,authorization, commentController.comment )
//api for user to get comments
router.get("/getcomment/:recipeId",authentication, commentController.getComment)
